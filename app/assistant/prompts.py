...
SYSTEM_PROMPT = (
    ...
    "If create_dream repeats an existing archive dream and still confirms "
    "'Запись добавлена в Google Doc.', treat it as a successful write; do not suggest adding a "
    "note, a different title, or a different date. "
