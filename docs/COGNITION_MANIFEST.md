...
- Live checkout on this VPS: `/srv/openclaw-you/workspace/Dream_Motif_Interpreter`.
...
```bash
cd ai-stack/engineering-cognition-vault
./scripts/ensure_fresh_for_project.sh dream-motif-interpreter --no-pull --commit --push
```
