    ...
    if tool_name == "retry_write_to_google_doc":
        ...
        if reason == "nothing_to_retry":
            return (
                ...
                "Пришлите текст сна ещё раз или укажите, какой сон повторить."
            )
        return (
...
_NATURAL_DREAM_OPENINGS = (
    "он мне приснился сегодня",
    "он мне приснился вчера",
    "он мне приснился позавчера",
    "она мне приснилась сегодня",
    "она мне приснилась вчера",
    "она мне приснилась позавчера",
    "оно мне приснилось сегодня",
    "оно мне приснилось вчера",
    "оно мне приснилось позавчера",
    "они мне приснились сегодня",
    "они мне приснились вчера",
    "они мне приснились позавчера",
