...
Version: 2.9
Last updated: 2026-08-30 (durable work and Telegram restart state)
...
| D-015 | 2026-05-01 | Superseded by D-022 | Dream recording reliability must move from prompt-only behavior to deterministic intake, pending-draft state, write status tracking, and honest success/failure responses | `docs/tasks_phase17.md` |
...
| D-022 | 2026-08-30 | Active | Canonical capture/voice work, leases and delivery cursors live in PostgreSQL; Redis may hold only TTL-protected private Telegram confirmation state and is required for production restart safety | ADR-011, `docs/ARCHITECTURE.md` |

## Notes

- Decisions through D-014, D-016, and D-018 through D-022 are Active; D-017 is superseded by D-020 and D-015 by D-022.
