...
Status: Active — UX quality fixes from Тест 1 (22.04.26)
...
- [ ] Поиск мифологических параллелей работает end-to-end (WS-12.1 + WS-12.9)
- [ ] Ответы не содержат markdown-разметки (WS-12.2)
- [ ] list_recent_dreams показывает описание вместо UUID/word_count (WS-12.3)
- [ ] search_dreams показывает название сна и вербальную силу связи (WS-12.4)
- [ ] Текст сна в get_dream не содержит * и < (WS-12.5)
- [ ] create_dream срабатывает на естественные русские фразы (WS-12.6)
- [ ] Заголовок сна при сохранении в формате «дд.мм.гг, без названия» (WS-12.7)

WS-12.8 и WS-12.10 могут быть выполнены после phase gate.
